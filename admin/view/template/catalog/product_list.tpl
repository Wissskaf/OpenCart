          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
               ...
               <div class="form-group">
                <label class="control-label" ><?php echo $entry_cost; ?></label>
                <select name="filter_cost"  class="form-control">
                  <option value="*"></option>
                  <?php if ($filter_cost) { ?>
                  <option value="1" selected="selected"><?php  ?>DESC</option>
                  <?php } else { ?>
                  <option value="1"><?php  ?>DESC</option>
                  <?php } ?>
                  <?php if (!$filter_cost && !is_null($filter_cost)) { ?>
                  <option value="0" selected="selected"><?php  ?>ASC</option>
                  <?php } else { ?>
                  <option value="0"><?php  ?>ASC</option>
                  <?php } ?>
                </select>
              </div>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'p.price') { ?>
                   ...
                   <td class="text-right"><?php if ($sort == 'p.cost') { ?>
                    <a href="<?php echo $sort_cost; ?>" class="<?php echo strtolower($order); ?>"><?php   ?>Cost</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_cost; ?>"><?php   ?>Cost</a>
                    <?php } ?></td>
...
$('#button-filter').on('click', function() {
  ...
  var filter_cost = $('select[name=\'filter_cost\']').val();
