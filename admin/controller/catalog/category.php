...
$product_count_query = $this->db->query("SELECT COUNT(*) AS count FROM " . DB_PREFIX . "product_to_category WHERE category_id = '" . (int)$result['category_id'] . "'");
    $product_count = (int)$product_count_query->row['count'];
    ...
    $category['count'] = $this->model_catalog_product->getTotalProducts(array('filter_category_id' => $category['category_id']));
}
unset($category);
